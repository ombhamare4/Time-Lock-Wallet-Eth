...
export default function Home() {
  ...
  const withdraw = async () => {
    try {
      ...
      console.log("timelockcontact" + timeLockContract);
        ...
        <>
          <div>
            <p className="text-center my-2 font-bold">
              Wallet Address Connected <span className="text-rose-500">{accountAddress}</span>
            </p>
            <p className="text-center my-2">Total Amount Locked UP <span className="text-green-500">Rs: {balance}</span></p>
          </div>
          ...
          <div className="mt-2">
            {balance && <p> Available Balance: {balance}</p>}
